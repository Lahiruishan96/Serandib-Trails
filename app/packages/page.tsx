...
// // PRICE CONFIGURATION
// // -----------------------------
// const PRICE_INCREASE = 1.3; // 30% increase
// const DISCOUNT = 1;        // 1 = no discount | 0.9 = 10% off | 0.8 = 20% off

// const applyPricingRules = (price: number) => {
//   return Math.round(price * PRICE_INCREASE * DISCOUNT);
// };

// // -----------------------------
// // BASE PRICING (DO NOT EDIT)
// // -----------------------------
// const baseTourPricingByVehicle = [
//   {
//     tour: "One Day Tour",
//     car: { budget: 130, gold: 180, premium: 250 },
//     van: { budget: 160, gold: 200, premium: 300 },
...
// // -----------------------------
// // FINAL PRICING (AUTO-CALCULATED)
// // -----------------------------
// const tourPricingByVehicle = baseTourPricingByVehicle.map((tour) => ({
//   tour: tour.tour,
//   car: {
//     budget: applyPricingRules(tour.car.budget),
//     gold: applyPricingRules(tour.car.gold),
//     premium: applyPricingRules(tour.car.premium),
//   },
//   van: {
//     budget: applyPricingRules(tour.van.budget),
//     gold: applyPricingRules(tour.van.gold),
//     premium: applyPricingRules(tour.van.premium),
//   },
//   bus: {
//     budget: applyPricingRules(tour.bus.budget),
//     gold: applyPricingRules(tour.bus.gold),
//     premium: applyPricingRules(tour.bus.premium),
//   },
// }));

// // -----------------------------
// // PACKAGE FEATURES (UNCHANGED)
// // -----------------------------
// const packagesData = [
//   {
//     id: 1,
...
//         },
//         "offers": [
//           ...["car", "van", "bus"].flatMap((vehicle) =>
//             ["premium", "gold", "budget"].map((tier) => ({
//               "@type": "Offer",
//               "price": tour[vehicle as "car" | "van" | "bus"][tier as "premium" | "gold" | "budget"],
//               "priceCurrency": "USD",
//               "url": "https://souloflanka.com/packages",
//             }))
//           ),
...
// -----------------------------
// DISCOUNT POP-UP COMPONENT (RESPONSIVE)
// -----------------------------
const DiscountPopup: React.FC = () => {
  ...
  return (
    <div className="fixed top-4 inset-x-4 sm:inset-x-auto sm:left-1/2 transform sm:-translate-x-1/2 z-50 bg-red-600 text-white px-4 sm:px-6 py-3 rounded-lg shadow-lg flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-4">
      <span className="font-semibold text-center sm:text-left text-base sm:text-lg">
         We're offering <strong>30% off</strong> these days! Book now!
      </span>
      <button
        onClick={() => setIsVisible(false)}
        className="text-white hover:text-gray-200 font-bold text-xl ml-0 sm:ml-4"
