...
// Team members
const teamMembers = [
  { id: 1, name: "Lahiru Ishan", title: "Chief Experience Officer", image: "/Images/Crew/Lahiru.png" },
  { id: 2, name: "M G D S K Gamage", title: "Director of People & Culture", image: "/Images/Crew/Gamage.jpg" },
  { id: 3, name: "Dashi Fernando", title: "Lead Cultural Guide ", image: "/Images/Crew/dashi.jpg" },
  { id: 4, name: "J T R Jayasooriya", title: "Director of Guide Operations", image: "/Images/Crew/Jayasooriya.jpg" },
  { id: 5, name: "Dilshan Dilanka", title: "Digital Marketing & Technology Strategist", image: "/Images/Crew/Dilanka.png" },
];
...
const structuredData = {
  ...
  "description": "Soul Of Lanka is a travel agency dedicated to authentic Sri Lanka experiences, offering personalized tours, local expertise, and unforgettable adventures."
};
...
const AboutPage: React.FC = () => {
  return (
    <div className="bg-white text-gray-800">
      <Head>
        <title>About Us | Soul Of Lanka - Authentic Sri Lanka Tours</title>
        <meta name="description" content="Meet the team at Soul Of Lanka. Discover our mission, values, and why we are the trusted travel agency for authentic Sri Lanka experiences." />
        <script
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
              Founded in 2018, we began as a small group of local travel enthusiasts frustrated by generic tourist itineraries. We believe the true magic of Sri Lanka lies off the beaten path—in a local kitchen, a remote tea estate, or a hidden temple only the locals know.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed border-l-4 border-amber-500 pl-4 py-2 italic bg-gray-50 rounded-lg">
              Our mission is simple: to share the authentic beauty and culture of Sri Lanka while ensuring our tours benefit local communities and preserve the environment.
            </p>
